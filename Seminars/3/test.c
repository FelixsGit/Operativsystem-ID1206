...
int main(){
	...
	green_create(&g0, testConsumerProducer, &a0);
	green_create(&g1, testConsumerProducer, &a1);
	green_create(&g2, testConsumerProducer, &a2);
	green_create(&g3, testConsumerProducer, &a3);
